...
BigEats.BigEatsServiceImpl = Ext.extend(Object, {
     ...
     *
     * @param {String}
     *            bigEatId is the big eat id to obtain the items for
     * @param {Function}
     *            callback is the callback to execute upon a successful
     *            request.
     * @param {Object}
     *            scope is the scope
     */
     ...
     *
     * @param {Array}
     *            options is the set of options associated with this
     *            request
     * @param {Boolean}
     *            success true if the request was successful, false
     *            otherwise
     * @param {Object}
     *            response is the response object for this request
     * @param {String}
     *            bigEatId is the big eat id associated with this
     *            request
     * @param {Function}
     *            callback is the callback to call
     * @param {Object}
     *            scope is the scope
     */
